...
class AdkDataset(Dataset):
    def __init__(
        ...
        """
        This is a dataset with an (almost) uniform distribution over the 102 conformation states of the MD simulated 4AKE protein. All states have approximately 585 particle images.
    ...
    def load_conformations(self):
        ...
        # conformations has shape [102, n_atoms, 3] containing the coordinates of all atoms in all 102 conformations

        # dict that maps the residue index to the name of the amino acid
        res_names = [r.name for r in t.topology.residues]
        ...
        # conformations shape [102, n_residues, 3] (102 being the total number of MD-simulated conformations)
